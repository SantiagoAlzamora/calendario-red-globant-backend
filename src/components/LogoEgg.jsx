...
export default function LogoEgg({ ...props }) {
  return (
    <svg
    ...
    >
      <defs>
        <style>
          {`.cls-1,.cls-3{fill:#37474f;}.cls-2{fill:#ffcb00;}.cls-2,.cls-3,.cls-4{fill-rule:evenodd;}.cls-4{opacity:0.1;isolation:isolate;fill:url(#Degradado_sin_nombre_4);}`}
        </style>
        <radialGradient
